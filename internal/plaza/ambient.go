...
// RenderAmbient draws the plaza's living detail — drifting fireflies. It is a
// pure function of time, drawn after the lighting pass so the motes glow
// regardless of how dim their surroundings are. Everything stays monochrome to
// preserve the color discipline.
